...
static void* const heap_base = ( void* )0x60000000; //the first address of the heap.
static const u32 heap_max_order = 20; //the heap size is 2^heap_max_order, this is also the size of the biggest block that can be assigned.
