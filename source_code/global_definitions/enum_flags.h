...
template <typename enum_type>
inline enum_type operator<<(enum_type left_argument, u32 right_argument)
{
    using underlying_type = __underlying_type(enum_type);
    return static_cast<enum_type>(static_cast<underlying_type>(left_argument) << right_argument);
}
