...
class vc_mailbox_property_tags
{
    ...
    private:
    struct tag_get_arm_memory_location
    {
        buffer_header a_buffer_header = {.size = sizeof(tag_get_arm_memory_location),
                                         .a_request_response_code = request_response_code::process_request};
        tag_header a_tag_header = {.a_tag_id = tag_id::get_arm_memory,
                                   .value_buffer_size = sizeof(tag_get_arm_memory_location::response),
                                   .response_request_code = {.response_size = 0, .is_response = 0}};
        union {
            struct
            {
