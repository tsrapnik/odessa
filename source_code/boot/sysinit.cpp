...
// Cache control
//
#define InvalidateInstructionCache() asm volatile("ic iallu" :: \
                                                      : "memory")
#define FlushPrefetchBuffer() asm volatile("isb" :: \
                                               : "memory")
...
// Barriers
//
#define DataSyncBarrier() asm volatile("dsb sy" :: \
                                           : "memory")
#define DataMemBarrier() asm volatile("dmb sy" :: \
                                          : "memory")

#define InstructionSyncBarrier() asm volatile("isb" :: \
                                                  : "memory")
#define InstructionMemBarrier() asm volatile("isb" :: \
                                                 : "memory")

#define CompilerBarrier() asm volatile("" :: \
                                           : "memory")
