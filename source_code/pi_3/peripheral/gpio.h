...
class gpio
{
    ...
    struct registers
    {
        ...
        u32 gplev0; //0x34
        u32 reserved_0x38_0x3c; //0x38-0x3c
        u32 gpeds0; //0x40
        u32 reserved_0x44_0x48; //0x44-0x48
        u32 gpren0; //0x4c
        u32 reserved_0x50_0x54; //0x50-0x54
        u32 gpfen0; //0x58
        u32 reserved_0x5c_0x60; //0x5c-0x60
        u32 gphen0; //0x64
        u32 reserved_0x68_0x6c; //0x68-0x6c
        u32 gplen0; //0x70
        u32 reserved_0x74_0x78; //0x74-0x78
        u32 gparen0; //0x7c
        u32 reserved_0x80_0x84; //0x80-0x84
        u32 gpafend0; //0x88
        u32 reserved_0x8c_0x90; //0x8c-0x90
