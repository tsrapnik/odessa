...
compiler_flags = -g -Wall -Og -mcpu=cortex-a53+fp+simd -ffreestanding -nostartfiles -std=c++17 -mstrict-align -fno-tree-loop-vectorize -fno-tree-slp-vectorize -Wno-nonnull-compare -fno-exceptions -fno-rtti -fno-builtin -nostdlib -nostdinc
