...
class buddy_heap
{
    ...
    static bool removed_from_free_block_list(block* this_block, usize order); //return true en frees the associated block_pointer when the block is in the list of free blocks of the given order.
